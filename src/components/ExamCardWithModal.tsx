...
export default function ExamCardWithModal({ recentGrades, hasSession }: Props) {
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              ...
              {EXAM_SETS.map(({ key, label, sub }) => (
                <button
                  key={key}
                  className="btn-secondary"
                  onClick={() => navigate(key)}
                  style={{ flexDirection: "column", gap: "2px", padding: "12px 20px" }}
                >
